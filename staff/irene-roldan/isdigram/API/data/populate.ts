...
import { User, Post } from './index' //busca por defecto un archivo index

mongoose.connect('mongodb://localhost:27017/isdigram')
    .then(() => User.deleteMany())
    .then(() => Post.deleteMany())
    .then(() => User.create({ame: 'Pepe Roni', birthdate: '2000-01-01', email: 'pepe@roni.com', username: 'peperoni', password: '123qwe123'}))
    .then(user1 => {
        let count = 1 
