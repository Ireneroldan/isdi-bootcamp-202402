  ...
  return (
    <section>
      <form onSubmit={handleSubmit}>
        ...
        <select className="block appearance-none w-1/2 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
        name="columnType"
        id="columnType"
